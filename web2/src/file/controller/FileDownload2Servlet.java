...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		DataFile2 df = new FileService().fileSelectDownload2(beforeFileName,uploadTime);
		System.out.println("df : "+ df);
		if(df!=null)
		{
			File file = new File(df.getFilePath());
			
			String endFileName = new String(df.getBeforeFileName().getBytes(),"ISO-8859-1");
