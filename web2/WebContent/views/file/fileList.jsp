...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% ArrayList<DataFile> list = (ArrayList<DataFile>)request.getAttribute("list"); %>
...
<tr>
<td><%= df.getFileName() %></td><td><%= df.getFileSize() %></td><td><%= df.getFileUser() %></td><td><%= df.getUploadTime() %></td>
